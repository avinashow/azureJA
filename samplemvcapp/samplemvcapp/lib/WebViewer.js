...
(function($) {
    ...
    PDFTron.WebViewer.prototype = {
         ...
         * @param {boolean} `true` to show the side window.
        ...
        loadDocument: function(url, options) {
            ...
            console.log("url to send annotations " + url);
        ...
        _correctRelativePath: function(path) {
            ...
            var pattern = /^(https?:\/\/|file:\/\/|ms-appdata:\/\/|ms-appx-web:\/\/|\/|blob:|%2F|filesystem:)/i;
     ...
     * @property {string} [documentType] The type of document the viewer will be used with. Valid values are "xod" and "pdf" (default is "xod").
     ...
     * @property {boolean} [startOffline=false] Whether to start loading the documentannot in offline mode or not. This can be set to true if the document had previously been saved to an offline database using WebViewer APIs. You'll need to use this option to load from a completely offline state.
